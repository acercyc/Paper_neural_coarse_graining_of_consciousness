...
\rlstart{4}        	
            ...
            Blindsight patients are able to track objects, avoid obstacles,and make above chance level judgements without conscious awareness of visual targets within the visual field without having any visual conscious experience. The direct stimulus-response mapping ($S\rightarrow{}R$) makes the internal neural circuit a non-NTIC process and results in unconscious processing. In the case of procedure memory, processes often relies on both the current environmental and system states to determine the next state of the processes\needref{Do I need ref??}. Therefore, they also fail to achieve high NTIC as well. 
...
\rlends
		...
		\begin{ants}
		    @ If both conditions are satisfied, information within the NTIC process becomes conscious. 
		    @ Our theory suggests that conscious processing should be linked to cognitive functions that require forward models and predictive information \critical{Need to list items vary carefully here.}
