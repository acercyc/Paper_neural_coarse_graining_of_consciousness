...
\rlstart{3}			
    		...
    		\begin{ants}
    		    @ As described above, if a process fails to meet either one of the two necessary conditions, information remains unconscious.
    		    
    		    @ We first consider the first condition: A process fails to achieve NTIC. 
    		    
    		    @ Many processes in the neural network system fall in this category. 
    		    
    		    @ When a process is not information closed the internal state of the process is largely determined by the environmental state. 
    		    
    		    @ In terms of perception, this indicates that the process only passively reacts.
    		    
    		    @ In terms of action, this implies reflective behaviours.
